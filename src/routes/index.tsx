  ...
  head: () => ({
    meta: [
      { title: "YAROS.TaskFlow — заметка превращается в ТЗ" },
      {
        name: "description",
        content:
          "Опишите задачу свободным текстом — AI соберёт техническое задание с критериями приёмки, приоритетом и категорией.",
      },
      { property: "og:title", content: "YAROS.TaskFlow — заметка превращается в ТЗ" },
      {
        property: "og:description",
        content: "От сырой мысли до готового технического задания и контроля выполнения.",
      },
    ],
  }),
  component: Index,
