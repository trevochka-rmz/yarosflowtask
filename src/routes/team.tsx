...
export const Route = createFileRoute("/team")({
  head: () => ({
    meta: [
      { title: "Команда — Yaya.ЦифровойБот" },
      {
        name: "description",
        content: "Сотрудники и руководители: роли, статус активности, контакты.",
      },
      { property: "og:title", content: "Команда — Yaya.ЦифровойБот" },
      { property: "og:description", content: "Список участников и их роли в цифровом боте." },
    ],
  }),
  component: TeamPage,
});
